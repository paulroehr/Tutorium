...
public abstract class PermissionUtils {
     ...
     */
    public static boolean verifyPermissions(int[] _GrantResults) {
    ...
    public static boolean hasSelfPermission(Context _Context, String[] _Permissions) {
    ...
    public static boolean hasSelfPermission(Context _Context, String _Permission) {
        // Below Android M all permissions are granted at install time and are already available.
        if (!isMNC()) {
            return true;
        }
        return ContextCompat.checkSelfPermission(_Context, _Permission) == PackageManager.PERMISSION_GRANTED;
    }
